        ...
        <div className={styles.countdown}>
          <div className={styles.count_item}>
            <div className={styles.count_rectangle}>
              <p className={styles.count_number} id='days'>{numberOfDays.toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false})}</p>
            </div>
            <p className={styles.count_name}>days</p>
          </div>
          <div className={styles.count_item}>
            <div className={styles.count_rectangle}>
              <p className={styles.count_number} id='hours'>{numberOfHours.toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false})}</p>
            </div>
            <p className={styles.count_name}>hours</p>
          </div>
          <div className={styles.count_item}>
            <div className={styles.count_rectangle}>
              <p className={styles.count_number} id='minutes'>{numberOfMinutes.toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false})}</p>
            </div>
            <p className={styles.count_name}>minutes</p>
          </div>
          <div className={styles.count_item}>
            <div className={styles.count_rectangle}>
              <p className={styles.count_number} id='seconds'>{numberOfSeconds.toLocaleString('en-US', {minimumIntegerDigits: 2, useGrouping:false})}</p>
            </div>
